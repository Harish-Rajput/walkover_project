<%-- 
    Document   : viewAllTables
    Created on : 13 Jun, 2022, 12:02:41 AM
    Author     : arrag
--%>
...
<body>
    ...
    <%
            ...
            ArrayList<TableListDTO> tlist = tldao.viewAllTable(username);
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <div class="card mb-4 mb-xl-0" style="padding: 12px;">
                ...
                <div style="padding-bottom: 12px;">All Tables</div>
                <div class="row">
