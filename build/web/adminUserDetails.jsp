...
<%
    ...
    UserDTO udto = udao.userDetails(uname);
    
    TableListDAO tdao = new TableListDAO();
    ArrayList<TableListDTO> tlist = tdao.viewAllTable(uname);
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
                        ...
                        <div class="card-body text-center">
                            <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary"><%=uname%></div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary"> <%=tlist.size()%></div>
                                </div>
                                <hr>
                        </div>
                    </div>
            ...
            <div class="card mb-4 mb-xl-0" style="padding: 12px;">
                ...
                <div style="padding-bottom: 12px;"><b>User Tables</b></div>
                <div class="row">
<%
    for(int i=0; i<tlist.size(); i++)
    {
        TableListDTO tdto = tlist.get(i); %>
