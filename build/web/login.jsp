  ...
  <body>
    ...
    <div class="wrapper">
      <div class="title-text">
        <div class="title login">Login with Email</div>
        <div class="title signup">Login with Username</div>
      </div>
      <div class="form-container">
        <div class="slide-controls">
          ...
          <label for="signup" class="slide signup">Username</label>
        ...
        <div class="form-inner">
            ...
            <div class="field">
                ...
                <input type="text" name="userid" onkeyup="this.value=removeSpaces(this.value);" id="username" placeholder="Enter Email" required />
            </div>
            <div class="field">
            ...
            <div class="field">
                <input type="hidden" value="username" name="mode">
